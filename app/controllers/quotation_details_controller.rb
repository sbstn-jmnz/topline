class QuotationDetailsController < ApplicationController
  ...
  private
    ...
    def quotation_detail_params
      params.require(:quotation_detail).permit(:product, :target_price, :quantity, :color, :size, :ratio, :delivery_date, :status, :incoterm, :final_price, :quotation_id, :basic_category_id)
    end
end
