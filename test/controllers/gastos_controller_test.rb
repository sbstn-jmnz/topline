...
class GastosControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create gasto" do
    assert_difference('Gasto.count') do
      post gastos_url, params: { gasto: { cargo: @gasto.cargo, cc: @gasto.cc, descripcion: @gasto.descripcion, fecha: @gasto.fecha, pagado: @gasto.pagado, saldo: @gasto.saldo } }
    end
  ...
  test "should update gasto" do
    patch gasto_url(@gasto), params: { gasto: { cargo: @gasto.cargo, cc: @gasto.cc, descripcion: @gasto.descripcion, fecha: @gasto.fecha, pagado: @gasto.pagado, saldo: @gasto.saldo } }
